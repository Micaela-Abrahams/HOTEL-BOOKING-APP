    ...
    <div class="container">
        ...
        <div class="grid-set">
            ...
            <div class="reserve-form-container">
                <form action="../pages/booking-process-4.php" method="POST" class="reserveForm">

                    <label for="hotel-name" name="hotel-name" style="font-weight: 500;"> Serene Haven Suites:
                    </label> <br>
